...
export const fixtures = {
  'Icon Browser': () => <IconBrowserPage />,
  /*
   * Approximate per-provider icon weight, to help you pick one deliberately — importing
   * two adapters ships two icon runtimes.
   */
  'Provider Size Comparison': () => <ProviderComparisonPage />,
};
