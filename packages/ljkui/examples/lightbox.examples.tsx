...
function WithZoomStory() {
  const zoomRef = useRef<React.ComponentRef<typeof Lightbox.Zoom>>(null);
...
/** The Overview grid. Named apart from this module's other `images`, which is a different shape. */
